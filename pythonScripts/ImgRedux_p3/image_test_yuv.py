...
#Open Log Files
log_op=open("yuv_original_matrix.txt",'w')
log_diff=open("yuv_diff_matrix.txt",'w')
log_re=open("yuv_rec_matrix.txt",'w')

#construct array from image
img=Image.open("img1.jpg").convert("YCbCr")
#img.load()
...
im=Image.fromarray(rec_array,mode="YCbCr")
im.save("reconstruct_img_yuv.jpg")